...
export default {
  ...
  methods: {
    ...
    end1(e) {
      ...
      let dragInner = e.item.innerHTML;
      this.dragObj.set(dragInner,dragInner);
    ...
    onMove(e, originalEvent) {
      let dragId = e.draggedContext.element.id;
      let dragName = e.draggedContext.element.name;
      console.log(this.dragObj.has(dragName));
      //   console.log(this.moveIdArr.includes(dragId));
      if (this.dragObj.has(dragName)) {
